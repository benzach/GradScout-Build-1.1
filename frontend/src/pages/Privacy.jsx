    ...
    <div className="bg-background px-4 py-8">
      <div className="max-w-sm mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 space-y-5">
          <div>
            <h1 className="font-heading text-lg font-bold text-primary-900">Privacy Notice</h1>
          ...
          <Section title="How long it's kept">
            <p>
              ...
              everything tied to it, at any time from Settings — immediately, with no waiting
              period and no "soft delete".
            </p>
          </Section>
