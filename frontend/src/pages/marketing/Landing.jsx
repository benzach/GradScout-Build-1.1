...
const FEATURES = [
  ...
  },
  {
    ...
    body: "Add GradScout to your phone's home screen and get notified the moment a new match lands, even with the app closed.",
  },
  {
    icon: Mail,
    title: "A weekly digest, if you'd rather",
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'The whole of the UK — from London and Manchester down to smaller towns — across industries including law, finance, technology, engineering, consulting, charity & nonprofit, and more. You choose which ones matter when you set up a search.',
  },
  {
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 py-20 sm:py-28">
        <Reveal className="max-w-xl">
          ...
          <h2 className="font-heading text-3xl sm:text-4xl font-extrabold text-background tracking-tight">
            Real listings, from sources you could check yourself
          </h2>
          <p className="text-primary-200 mt-4 leading-relaxed">
            GradScout scans official job board sources rather than screen-scraping personal sites.
            Every listing links straight back to where it was originally posted — you always apply
